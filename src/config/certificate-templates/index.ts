...
export const Template3 = {
    ...
    classNames: {
        title: "absolute font-sharjah text-[134px] text-[#5f7f80]",     // أوضح من #b6d0d1
        subtitle: "absolute font-alhoda text-4xl text-[#e07a3d]",       // أوضح من #fad1b3
        name: "absolute font-bold text-8xl text-[#5f7f80] whitespace-nowrap",
        line2: "absolute text-5xl text-center text-[#4a6a92]",          // أوضح من #d3dfeb
        date: "absolute text-3xl text-[#333333]",                       // أغمق لزيادة الوضوح
        sign: "absolute text-3xl text-[#333333]",                       // نفس الفكرة
    },
    positions: {
