...
export default function HeroSection() {
    ...
    useEffect(() => {
        const timer = setInterval(() => {
            setCurrentIndex((prev) => (prev + 1) % PictureSlides.length)
        }, SLIDE_INTERVAL)
    ...
    return (
        <section className="relative min-h-[90vh] flex items-center justify-center overflow-hidden bg-gradient-to-br from-[var(--color-bg-container)] via-[var(--color-bg-base)] to-[var(--color-bg-layout)]">
                ...
                <div className="grid lg:grid-cols-2 gap-12 items-center">
                    ...
                    >
                        <div className="relative w-full max-w-md mx-auto">
                            ...
                            <div
                                className="relative aspect-square rounded-3xl overflow-hidden bg-gradient-to-br from-[var(--color-primary)] to-[var(--color-primary-active)] p-1 cursor-pointer"
                                onClick={() => setLightboxOpen(true)}
                            >
                                <div className="w-full h-full bg-[var(--color-bg-container)] rounded-3xl flex items-center justify-center">
                                    <img
                                        src={PictureSlides[currentIndex]}
            ...
            <Lightbox
                ...
                index={currentIndex}
                slides={PictureSlides.map((src) => ({ src }))}
            />
