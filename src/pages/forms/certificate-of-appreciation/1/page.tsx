...
import CertificateOfAppreciationTemplate_1_Form from "./form";
import CertificateOfAppreciationTemplate_1_Viewer, {
...
export default function CertificateOfAppreciationTemplate_1_Page() {
    const [formData, setFormData] = useState<CertificateProps[]>([]);
    ...
    const handleFormDataChange = useCallback((newData: CertificateProps[]) => {
        setImages([]);
        setFormData(newData);
    }, []);
        ...
        <TemplatesLayout>
            <div className="container mx-auto px-4 py-10 space-y-2">
                ...
                <div className="bg-white relative p-6 rounded-xl shadow-lg w-full">
                    <CertificateOfAppreciationTemplate_1_Form
                ...
                {formData.map((data, i) => (
                    <CertificateOfAppreciationTemplate_1_Viewer
